...
var FontSizeSettings = function(node) {
	...
	$('<table id="font-size-table"><tr><td><span style="font-size:' + sofia.config.fontSizeMin + 'px">' + sofia.config.fontSizeLetter + '</span><td style="width:100%"></td><td><span style="font-size:' + sofia.config.fontSizeMax + 'px">' + sofia.config.fontSizeLetter + '</span></td></tr></table>')
		.appendTo(body);
