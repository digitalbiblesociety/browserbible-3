...
function generate(inputPath, outputPath, indexOutputPath, info, createIndex) {
	...
	for (var i=0, il=lines.length; i<il; i++) {
		...
		if (verse == '1') {
			...
			currentChapter['text'] += '<div class="c">' + chapter + "</div>" + breakChar;
			currentChapter['text'] += '<div class="p">' + breakChar;
		}
			
		currentChapter['text'] += 
				'<span class="verse-num v-' + verse + '">' + verse + '&nbsp;</span>' + 
				'<span class="verse ' + verseCode + '" data-id="' + verseCode + '">' + text + ' </span>' + breakChar;
		
		if (createIndex) {
			verseIndexer.indexVerse(indexOutputPath, verseCode, text, indexData);
		}
