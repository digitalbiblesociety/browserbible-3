...
function generate(inputPath, outputPath, indexOutputPath, info, createIndex) {
	...
	if (singleBookIndex > -1) {
		processBook( separator + chunks[singleBookIndex] , info, inputPath, outputPath, indexOutputPath, indexData, createIndex);		
		...
		for (var i=1; i<chunks.length; i++) {
			...
			processBook(bookXml, info, inputPath, outputPath, indexOutputPath, indexData, createIndex);		
		}
	}
...
function processBook(bookXml, info, inputPath, outputPath, indexOutputPath, indexData, createIndex) {
