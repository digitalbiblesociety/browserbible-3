...
'</table>' +
			...
			button = $('<div class="config-button" id="config-eng2p-button"><svg class="icon"><use xlink:href="' + sofia.config.icons + '#eng2p-button"></use></svg><span class="i18n" data-i18n="[html]plugins.eng2p.title"></span></div>')
