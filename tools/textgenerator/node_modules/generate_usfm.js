...
function generate(inputBasePath, outputBasePath, indexOutputPath, info, createIndex) {
		...
		for (var i=0,il=lines.length; i<il; i++) {
			...
			switch (usfm.key) {
				...
				case 'p':
					...
					if (usfm.text != '') {
						currentChapterHtml += '<span class="verse ' + currentVerseCode + '" data-id="' + currentVerseCode + '">' + usfmParser.formatText(usfm.text);				
						verseIsOpen = true;
				...
				case 'v':
					...
					currentChapterHtml += 
										'<span class="verse-num v-' + currentVerseNum + '">' + currentVerseNum + '&nbsp;</span>' + 
										'<span class="verse ' + currentVerseCode + '" data-id="' + currentVerseCode + '">' + usfmParser.formatText(usfm.text);
	...
	for (var i=0, il=chapterData.length; i<il; i++) {
		var chapter = chapterData[i],
			...
			html = 
				'<!DOCTYPE html>' + 
				'<html><head><title>' + chapter.id + '</title></head>' + 
				'<body>' + 
